  ...
  >
    <div>
      ...
      <ApprovalFlow
        v-else
        ref="approvalFlowRef"
        :flowId="currentContractData?.checkFlowId"
    ...
    <template #footer>
      <div class="dialog-footer">
        <ApprovalButtons
          :current-data="currentContractData"
...
<script setup name="ProcurementContractDetail">
...
const isApprovalFlowEditable = computed(() => {
  return [0, 3, 4].includes(Number(currentContractData.value?.checkStatus));
});
