<template>
  ...
  >
    <!-- 外出基本信息 -->
    <div class="form-section-title">外出基本信息</div>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-form-item label="外出天数" prop="duration">
          <el-input-number
    ...
    <!-- 外出事由 -->
    <div class="form-section-title">外出事由</div>
...
const rules = {
  ...
  duration: [{ required: true, message: "请输入外出天数", trigger: "blur" }],
