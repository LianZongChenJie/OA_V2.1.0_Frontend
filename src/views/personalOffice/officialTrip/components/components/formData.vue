<template>
  ...
  >
    <!-- 出差基本信息 -->
    <div class="form-section-title">出差基本信息</div>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-form-item label="出差天数" prop="duration">
          <el-input-number
    ...
    <!-- 出差事由 -->
    <div class="form-section-title">出差事由</div>
...
const rules = {
  ...
  duration: [{ required: true, message: "请输入出差天数", trigger: "blur" }],
