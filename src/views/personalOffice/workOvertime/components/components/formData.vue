<template>
  ...
  >
    <!-- 加班基本信息 -->
    <div class="form-section-title">加班基本信息</div>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-form-item label="加班时长(小时)" prop="duration">
          <el-input-number
    ...
    <!-- 加班事由 -->
    <div class="form-section-title">加班事由</div>
...
<script setup name="OfficialTripFormData">
...
const rules = {
  ...
  duration: [{ required: true, message: "请输入加班小时数", trigger: "blur" }],
