<template>
  ...
  >
    <el-form ref="formRef" :model="form" :rules="isView ? {} : rules" label-width="120px">
      <el-form-item label="奖罚项目" prop="title">
        <el-input v-model="form.title" placeholder="请输入奖罚项目" :disabled="isView" />
      </el-form-item>
...
import { addenterPrise, updateenterPrise } from "@/api/base/hr/rewards/index.js";
...
const rules = {
  title: [{ required: true, message: "请输入奖罚项目", trigger: "blur" }],
 };
