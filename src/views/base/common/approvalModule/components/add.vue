  ...
  >
    <el-form ref="formRef" :model="form" :rules="isView ? {} : rules" label-width="120px">
      <el-form-item label="模块名称" prop="title">
        <el-input v-model="form.title" placeholder="请输入模块名称" :disabled="isView" />
      </el-form-item>
...
import { addMessageModule, updateMessageModule } from "@/api/base/common/approvalModule/index.js";
...
const dialogTitle = computed(() => {
  if (isView.value) return "查看审批模块";
  return isEdit.value ? "编辑审批模块" : "新增审批模块";
});
