  ...
  >
    <el-form ref="formRef" :model="form" :rules="isView ? {} : rules" label-width="120px">
      <el-form-item label="单位名称" prop="title">
        <el-input v-model="form.title" placeholder="请输入单位名称" :disabled="isView" />
      </el-form-item>
       <el-form-item label="排序" prop="sort">
        <el-input v-model="form.sort" placeholder="请输入配许" :disabled="isView" />
      </el-form-item>
...
<script setup name="AddassetUnit">
import { ref, reactive, computed, getCurrentInstance } from "vue";
import { addenterPrise, updateenterPrise } from "@/api/base/administration/assetUnit/index.js";
...
const dialogTitle = computed(() => {
  if (isView.value) return "查看资产单位";
  return isEdit.value ? "编辑资产单位" : "新增资产单位";
});
