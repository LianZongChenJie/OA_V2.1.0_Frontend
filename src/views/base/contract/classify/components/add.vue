...
<script setup name="Addclassify">
import { ref, reactive, computed, getCurrentInstance } from "vue";
import { addenterPrise, updateenterPrise } from "@/api/base/contract/classify/index.js";
...
const dialogTitle = computed(() => {
  if (isView.value) return "查看合同分类";
  return isEdit.value ? "编辑合同分类" : "新增合同分类";
});

const rules = {
  title: [{ required: true, message: "请输入合同分类", trigger: "blur" }],
 };
